...
for (i in 1:length(variables_to_plot)) {
  hist(data[, variables_to_plot[i]], main = paste("Histogram of", variables_to_plot[i]), xlab = variables_to_plot[i])
}
...
par(mfrow = c(1, 2))
hist(scaled_student$Performance.Index, main = "Original Histogram", xlab = "Original Variable")
hist(sqrt_student$Performance.Index, main = "Sqrt Transformed Histogram", xlab = "Sqrt Transformed Variable")
...
# Plot histogram of original and transformed variable
par(mfrow = c(1, 2))
hist(student$Performance.Index, main = "Original Histogram", xlab = "Original Variable")
hist(log_student$Performance.Index, main = "Log Transformed Histogram", xlab = "Log Transformed Variable")
